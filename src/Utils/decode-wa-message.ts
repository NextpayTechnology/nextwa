...
export function decodeMessageNode(stanza: BinaryNode, meId: string, meLid: string) {
	...
	// [PATCH-019] cherry-pick Baileys 798f2a93 — fail-fast com mensagem clara
	// se stanza chegou malformado, em vez de propagar `undefined!` e quebrar
	// downstream com TypeError opaco.
	if (!msgId) {
